...
// Active tab
className="border-b-2 border-[var(--color-iblue)] text-[var(--color-iblue)]"
...
focus:ring-[var(--color-iblue)] focus:border-[var(--color-iblue)]
...
bg-[var(--neutral-100)] hover:border-[var(--color-iblue-variant)]
Centered icon + "Upload a file" link + "or drag and drop" text

/* Submit Button */
bg-[var(--color-iblue)] text-white font-medium rounded-md
hover:bg-[var(--color-iblue-600)]
disabled:opacity-50
...
:root {
  /* Primary */
  --color-iblue: #1edde1; /* Bright cyan - main action color */
  --color-iblue-600: #08345a; /* Dark blue - hover state */
  --color-iblue-variant: #00d3f2; /* Light cyan - accents */
...
```tsx
className = "bg-[var(--color-iblue)] border-[var(--neutral-500)]";
```
